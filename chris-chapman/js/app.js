...
function displayPics(){
  ...
  // when using 'let', rando is defined only until the end of the loop of "while(viewed.length < 6)". Since rando is not a declared variable outside of that while loop, we get a reference error when it is called outside of that block, such as in the console.log (on line 37) above.  
  console.log(viewed)
